...
<div class="plant-card white-bg shadow-md rounded-lg overflow-hidden hover:translate-y-[-5px] transition">
    ...
    <div class="plant-info p-6 text-center">
        ...
        <button class="boxed-btn" onclick="location.href='{{ route('corona') }}'">Más información</button>
    </div>
</div>
...
<div class="plant-card white-bg shadow-md rounded-lg overflow-hidden hover:translate-y-[-5px] transition">
    ...
    <div class="plant-info p-6 text-center">
        ...
        <button class="boxed-btn" onclick="location.href='{{ route('aloe') }}'">Más información</button>
    </div>
</div>
...
<div class="plant-card white-bg shadow-md rounded-lg overflow-hidden hover:translate-y-[-5px] transition">
    ...
    <div class="plant-info p-6 text-center">
        ...
        <button class="boxed-btn" onclick="location.href='{{ route('coleo') }}'">Más información</button>
    </div>
</div>
...
<div class="plant-card white-bg shadow-md rounded-lg overflow-hidden hover:translate-y-[-5px] transition">
    ...
    <div class="plant-info p-6 text-center">
        ...
        <button class="boxed-btn" onclick="location.href='{{ route('croton') }}'">Más información</button>
    </div>
</div>
        </div>
    </div>
